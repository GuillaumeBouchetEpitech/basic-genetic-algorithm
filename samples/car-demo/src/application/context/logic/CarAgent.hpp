...
public: // setter/getter
	...
	inline const t_sensors&	getSensors() const { return _sensors; }


	inline float	getFitness() const { return _fitness; }
	inline bool		isAlive() const { return _alive; }

	float			getLife() const;

	inline unsigned int	getTotalUpdates() const { return _total_updates; }
	inline const std::vector<Line>&	getTrail() const { return _trail; };
