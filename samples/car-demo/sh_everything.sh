...
func_handle_third_parties() {
  ...
  DIR_THIRDPARTIES=$DIR_ROOT/../../thirdparties
...
func_build_main_application() {
  ...
  make build_mode="release" build_platform="native" all -j4 || exit 1
  ...
  make build_mode="release" build_platform="web-wasm" all -j4 || exit 1
